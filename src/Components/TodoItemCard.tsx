...
export const TodoItemCard = ({
  ...
  return (
    <li
      ...
      className={`group relative w-full mb-3.5 border-2 border-[#33322E] rounded-[12px] shadow-[4px_4px_0px_#33322E] hover:shadow-none transition-all duration-150 select-none overflow-hidden ${
    ...
    >
      {isEditing ? (
        ...
        <div
          className="relative min-h-[58px] pl-14 pr-28 py-4 cursor-pointer flex items-center"
        ...
        >
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
            ...
            {!isTrashView && (
              <>
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    if (onMoveUp) onMoveUp(todo.id);
                  }}
                  title="Move task up"
                  className={`w-[26px] h-[26px] rounded-[6px] border-2 border-[#33322E] flex items-center justify-center font-black text-xs transition-all ${
                    isFirst
                      ? "opacity-30 cursor-not-allowed bg-stone-100"
                      : "bg-white hover:bg-[#f5d99e] hover:shadow-[2px_2px_0px_#33322E] hover:-translate-y-0.5 cursor-pointer active:translate-y-0 active:shadow-none"
                  }`}
                >
                  ▲
                </button>
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    if (onMoveDown) onMoveDown(todo.id);
                  }}
            ...
            {/* Trash Actions or Delete Button */}
            {isTrashView ? (
              <>
                <button
                  type="button"
                  ...
                  title="Restore todo"
                  className="w-[28px] h-[28px] rounded-[6px] bg-white border-2 border-[#33322E] flex items-center justify-center cursor-pointer hover:bg-[#8CD4CB] hover:shadow-[2px_2px_0px_#33322E] hover:-translate-y-0.5 transition-all"
                >
                ...
                {onPermanentDelete && (
                  <button
                    ...
                    className="w-[28px] h-[28px] rounded-[6px] bg-white border-2 border-[#33322E] flex items-center justify-center cursor-pointer hover:bg-[#F6A89E] hover:shadow-[2px_2px_0px_#33322E] hover:-translate-y-0.5 transition-all"
                  >
              ...
              <button
                ...
                title="Delete item"
                className="w-[28px] h-[28px] rounded-[6px] bg-white border-2 border-[#33322E] flex items-center justify-center cursor-pointer hover:bg-[#F6A89E] hover:shadow-[2px_2px_0px_#33322E] hover:-translate-y-0.5 transition-all active:translate-y-0"
              >
