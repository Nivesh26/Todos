...
const Home = () => {
  ...
  const handleSaveSlogan = () => {
    setSlogan(tempSlogan.trim() || DEFAULT_SLOGAN);
    setIsEditingSlogan(false);
  };

  return (
    <main className="relative min-h-screen w-full overflow-x-hidden flex flex-col items-center py-10 px-4 md:px-8">
      {/* Header Container */}
